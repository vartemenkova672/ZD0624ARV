CLASS zarv4_cl_inventory DEFINITION
  PUBLIC
...
CLASS ZARV4_CL_INVENTORY IMPLEMENTATION.
  ...
  METHOD book_add.
    ...
    ms_transaction_data_changed-transaction_description = 'Purchase of inventory' ##NO_TEXT.
  ...
  METHOD write_off_add.
    ...
    ms_transaction_data_changed-transaction_description = 'Write-off of inventory' ##NO_TEXT.
    ms_transaction_data_changed-transaction_price = ms_transaction_data-transaction_amount / ms_transaction_data-transaction_quantity.
  ENDMETHOD.
ENDCLASS.
